...
public class Background {
    public final int ARRAY_WIDTH = 40;
    public final int ARRAY_HEIGHT = 30;
    public final int WINDOW_WIDTH = 800;
    public final int WINDOW_HEIGHT = 600;
    public final int ZOOM_RATIO = 20;
    ...
    */
    public Color get(int xAxis, int yAxis, int pictureNum) {
        xAxis /= ZOOM_RATIO;
        yAxis /= ZOOM_RATIO;
     ...
     * @return the Color object that from "java.awt.Color"
     */
    public Color get(final int[] xyAxis, int pictureNum) {
     ...
     * @return the Color object that from "java.awt.Color"
     */
    public Color get(final Point xyAxis, int pictureNum) {
     ...
     */
    public Color[][] getWholeArray(int pictureNum) {
    ...
    //[background No.][x][y] initizar size: [2][WIDTH][HEIGHT]
    public final Color[][][] colorPixels = 
    //No.1
